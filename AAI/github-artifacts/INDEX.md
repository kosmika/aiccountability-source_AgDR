...
This folder contains copies of all canonical artifacts from the AgDR GitHub repository.
...
|---|---|---|
| [agdr-v0.2.json](agdr-v0.2.json) | Canonical AgDR v0.2 spec (machine-readable) | `specs/agdr-v0.2.json` |
...
3. Commits and pushes back to `main` (tagged `[skip ci]`)

---

## Additional Documents (repo root)
